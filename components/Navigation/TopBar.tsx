...
import { Bell, User as UserIcon, Compass } from 'lucide-react';

export const TopBar: React.FC = () => {
  return (
    <div className="absolute top-0 left-0 right-0 h-14 z-40 flex items-center justify-between px-4 bg-gradient-to-b from-black/60 to-transparent pointer-events-none">
      {/* App Title / Logo */}
